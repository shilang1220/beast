...
public class GeometricPlotter extends Plotter {
  ...
  public void setup(BeastOptions opts) {
    super.setup(opts);
    this.strokeColor = CommonVisualizationHelper.getColor(opts.getString(StrokeColor, "Black"));
    this.fillColor = CommonVisualizationHelper.getColor(opts.getString(FillColor, "None"));
    ...
    switch (geom.getGeometryType()) {
      ...
      case "Polygon":
        ...
        if (polygon.isRectangle()) {
          ...
          boolean fill = fillColor.getAlpha() != 0;
  ...
  public void readExternal(ObjectInput in) throws IOException {
    this.strokeColor = new Color(in.readInt(), true);
    this.fillColor = new Color(in.readInt(), true);
    this.pointsize = in.readInt();
    this.antialiasing = in.readBoolean();
    this.usePureJavaGraphics = in.readBoolean();
  }
}
