...
class IntersectionsIterator1(FileIDs:util.ArrayList[Int], intersectionsList : util.ArrayList[Intersections]) extends Iterator[(Long, (Int, Int, Int, Int))]  {
  var i: Int = 0
  var j: Int = -1
  ...
  override def next(): (Long, (Int, Int, Int, Int)) = {
    if(j == -1)
    {
    ...
    (RasterSplitID,(PolygonIndex,Y,X1,X2))
  }
